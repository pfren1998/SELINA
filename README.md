...
Here you can use our pretrained models (available on [SELINA models](https://github.com/wanglabtongji/SELINA_reference)) or the model generated by yourself to predict for your query data. Note that if you want to annotate the disease data, you should add the --disease argument.
